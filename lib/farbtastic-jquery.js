// Original Source: https://raw.githubusercontent.com/mattfarina/farbtastic/master/src/farbtastic.js
// Slightly modified for use in node.js
import browserSupport from './jquery.browser.support';
import jq from 'jquery';

var jQuery = browserSupport(jq);

// Farbtastic 2.0.0-alpha.1
(function ($) {
  var __debug = false;
  var G_vmlCanvasManager, am, color2, tan, x2, xm, y2, ym;
