...
class Stats extends Component {
  constructor(props) {
    super(props);
    const searchText = getPath(this.props, 'match.params.color', '');
  ...
  componentWillUpdate(nextProps, nextState) {
    ...
    this.props.history.replace(`/colorify/stats/${encodeURIComponent(colorString)}`);
  }
  handleSearch = (e) => {
              ...
              <Row>
                <Col md={8} xs={8}>
                  ...
                  >
                    <Label
                      bsStyle={
                        this.state.stats.parseSuccessful ? 'success' : 'danger'
                      }
                    >
                      parsed
                    </Label>
            ...
            <div className="well">
              <Row>
                <Col md={12} xs={12}>
                  ...
                  <h5 className="pull-right">
                    <small>
                      {format(this.state.color.hsl()._hue, 0, 360, 2)}&deg;
                    </small>
                  </h5>
                </Col>
              </Row>
              ...
              <Row>
                <Col md={12} xs={12}>
                  ...
                  <h5 className="pull-right">
                    <small>
                      {format(this.state.color.hsl()._saturation, 0, 100, 2)}%
                    </small>
                  </h5>
                </Col>
              </Row>
              ...
              <Row>
                <Col md={12} xs={12}>
                  <h4 className="pull-left">
                    luminance{' '}
                    <span style={{ fontSize: '0.6em' }}>(lightness)</span>
                  </h4>
                  <h5 className="pull-right">
                    <small>
                      {format(this.state.color.hsl()._lightness, 0, 100, 2)}%
                    </small>
                  </h5>
                </Col>
              </Row>
              ...
              <Row>
                <Col md={12} xs={12}>
                  ...
                  <h5 className="pull-right">
                    <small>{format(this.state.color.red(), 0, 255, 0)}</small>
                  </h5>
                </Col>
              </Row>
              <Rect
              ...
              <Row>
                <Col md={12} xs={12}>
                  ...
                  <h5 className="pull-right">
                    <small>{format(this.state.color.green(), 0, 255, 0)}</small>
                  </h5>
                </Col>
              </Row>
              <Rect
              ...
              <Row>
                <Col md={12} xs={12}>
                  ...
                  <h5 className="pull-right">
                    <small>{format(this.state.color.blue(), 0, 255, 0)}</small>
                  </h5>
                </Col>
              </Row>
              <Rect
              ...
              <Row>
                <Col md={12} xs={12}>
                  ...
                  <h5 className="pull-right">
                    <small>{format(this.state.color.alpha(), 0, 1, 3)}</small>
                  </h5>
                </Col>
              </Row>
              <Rect
