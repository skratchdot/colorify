...
module.exports = React.createClass({
	...
	render: function () {
		...
		buttons.push(
			<Button bsStyle="default" bsSize="xsmall" key="normal"
				className={this.props.stats.schemes.hasOwnProperty(this.props.selectedScheme) ? '' : 'active'}
				data-scheme="Normal"
		...
		for (const schemeName in schemes) {
			if (schemes.hasOwnProperty(schemeName)) {
				buttons.push(
					<Button bsStyle="default" bsSize="xsmall" key={schemeName}
