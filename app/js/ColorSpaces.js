			...
			<Row>
				...
				<Col md={6}>
					<Table striped bordered hover>
						...
						<tbody>
							<tr><td>{color.hexString}</td></tr>
							<tr><td>{color.rgbString}</td></tr>
							<tr><td>{color.rgbaString}</td></tr>
							<tr><td>{color.percentString}</td></tr>
							<tr><td>{color.hslString}</td></tr>
							<tr><td>{color.hslaString}</td></tr>
						</tbody>
					</Table>
				</Col>
			</Row>
